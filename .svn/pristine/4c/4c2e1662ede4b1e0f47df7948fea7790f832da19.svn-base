...
* @modifyauthor Elkan <senhui19@gmail.com>
...
(function(undefined) {
    ...
    KE.setting = {
        ...
        statusbarHeight: 11,
        items: ["source", "preview", "|", "fullscreen", "undo", "redo", "print", "cut", "copy", "paste", "plainpaste", "wordpaste", "|", "justifyleft", "justifycenter", "justifyright", "justifyfull", "insertorderedlist", "insertunorderedlist", "indent", "outdent", "subscript", "superscript", "date", "time", "|", "selectall", "-", "title", "fontname", "fontsize", "|", "textcolor", "bgcolor", "bold", "italic", "underline", "strikethrough", "removeformat", "|", "image", "accessory", "flash", "media", "advtable", "hr", "emoticons", "link", "unlink", "specialchar", "|", "about"],
    ...
    KE.range = function(doc) {
        ...
        this.getParentElement = function() {
            ...
            var nodeList = [];
            scanParent(this.startNode,
            function(node) {
                nodeList.push(node)
            });
            var parentNode;
            scanParent(this.endNode,
            function(node) {
    ...
    KE.cmd = function(id) {
        ...
        this.remove = function(tags) {
            ...
            for (var i = 0,
            length = nodeList.length; i < length; i++) {
                var node = nodeList[i];
                if (node.nodeType == 1) {
    ...
    KE.format = {
        ...
        getHtml: function(html, htmlTags, urlType) {
            ...
            html = html.replace(/(<pre[^>]*>)([\s\S]*?)(<\/pre>)/ig,
            function($0, $1, $2, $3) {
    ...
    KE.util = {
        ...
        inMarquee: function(node) {
            var n = node;
            while (n) {
                if (n.nodeName.toLowerCase() === "marquee") {
                    return true
                }
                n = n.parentNode
            }
        ...
        pluginLang: function(pluginName, doc) {
            KE.each(KE.lang.plugins[pluginName],
            function(key, val) {
        ...
        addTabEvent: function(id) {
            KE.event.add(KE.g[id].iframeDoc, "keydown",
            function(e) {
                if (e.keyCode == 9) {
        ...
        addContextmenuEvent: function(id) {
            ...
            KE.event.add(g.iframeDoc, "contextmenu",
            function(e) {
                KE.hideMenu(id);
                KE.util.setSelection(id);
                ...
                var items = [];
                for (var i = 0,
                len = g.contextmenuItems.length; i < len; i++) {
        ...
        addNewlineEvent: function(id) {
            ...
            KE.event.add(g.iframeDoc, "keydown",
            function(e) {
    ...
    KE.colorpicker = function(arg) {
        ...
        this.create = function() {
            ...
            KE.event.bind(wrapper, "click",
            function(e) {});
            KE.event.bind(wrapper, "mousedown",
            function(e) {});
    ...
    KE.menu = function(arg) {
        ...
        function init() {
            ...
            KE.event.bind(div, "click",
            function(e) {},
            arg.id);
            KE.event.bind(div, "mousedown",
            function(e) {},
            arg.id);
            this.div = div
        }
    ...
    KE.dialog = function(arg) {
        ...
        this.show = function() {
            ...
            if (KE.g[id].shadowMode) {
                KE.addClass(span, "ke-dialog-close-shadow")
            } else {
                KE.addClass(span, "ke-dialog-close-no-shadow")
            }
            ...
            KE.util.drag(id, titleDiv, div,
            function(objTop, objLeft, objWidth, objHeight, top, left) {
                if (self.ondrag) {
                    self.ondrag(id)
                }
                setLimitNumber();
    ...
    KE.create = function(id, mode) {
        ...
        KE.event.bind(maskDiv, "click",
        function(e) {},
        id);
        KE.event.bind(maskDiv, "mousedown",
        function(e) {},
        id);
        ...
        if (KE.browser.IE) {
            KE.event.add(iframeDoc, "keydown",
            function(e) {
                if (e.keyCode == 8) {
                    var range = KE.g[id].range;
                    if (range.item) {
        ...
        KE.util.drag(id, bottomRight, container,
        function(objTop, objLeft, objWidth, objHeight, top, left) {
        ...
        KE.util.drag(id, bottomLeft, container,
        function(objTop, objLeft, objWidth, objHeight, top, left) {
        ...
        KE.g[id].setHtmlHooks.push(function(html) {
            return html.replace(/(<[^>]*)(href|src)="([^"]+)"([^>]*>)/ig,
    ...
    KE.onchange = function(id, func) {
        ...
        KE.event.add(g.iframeDoc, "mouseup",
        function(e) {
            window.setTimeout(function() {
                func(id)
            },
    ...
    a.plugin.undo = {
        init: function(c) {
            a.event.ctrl(a.g[c].iframeDoc, "Z",
            function(d) {
                a.plugin.undo.click(c);
                a.util.focus(c)
            },
            c);
            a.event.ctrl(a.g[c].newTextarea, "Z",
            function(d) {
                a.plugin.undo.click(c);
                a.util.focus(c)
            },
        ...
        click: function(c) {
            a.history.undo(c);
            a.util.execOnchangeHandler(c)
        }
    };
    a.plugin.redo = {
        init: function(c) {
            a.event.ctrl(a.g[c].iframeDoc, "Y",
            function(d) {
                a.plugin.redo.click(c);
                a.util.focus(c)
            },
            c);
            a.event.ctrl(a.g[c].newTextarea, "Y",
            function(d) {
                a.plugin.redo.click(c);
                a.util.focus(c)
            },
    ...
    a.plugin.cut = {
        click: function(d) {
            try {
                if (!a.g[d].iframeDoc.queryCommandSupported("cut")) {
                    throw "e"
                }
            } catch(c) {
            ...
            a.util.execCommand(d, "cut", null)
        }
    };
    a.plugin.copy = {
        click: function(d) {
            try {
                if (!a.g[d].iframeDoc.queryCommandSupported("copy")) {
                    throw "e"
                }
            } catch(c) {
            ...
            a.util.execCommand(d, "copy", null)
        }
    };
    a.plugin.paste = {
        click: function(d) {
            try {
                if (!a.g[d].iframeDoc.queryCommandSupported("paste")) {
                    throw "e"
                }
            } catch(c) {
            ...
            a.util.execCommand(d, "paste", null)
        }
    };
    a.plugin.plainpaste = {
        click: function(c) {
        ...
        exec: function(e) {
            var c = a.util.getIframeDoc(this.dialog.iframe);
            var d = a.$("textArea", c).value;
            d = a.util.escape(d);
            d = d.replace(/ /g, "&nbsp;");
            d = d.replace(/\r\n|\n|\r/g, "<br />$&");
            a.util.insertHtml(e, d);
            this.dialog.hide();
            a.util.focus(e)
        }
    };
    a.plugin.wordpaste = {
        ...
        exec: function(c) {
            ...
            var e = a.$("wordIframe", g);
            var i = a.util.getIframeDoc(e).body.innerHTML;
            i = i.replace(/<meta(\n|.)*?>/ig, "");
            i = i.replace(/<!(\n|.)*?>/ig, "");
            i = i.replace(/<style[^>]*>(\n|.)*?<\/style>/ig, "");
            i = i.replace(/<script[^>]*>(\n|.)*?<\/script>/ig, "");
            ...
            i = i.replace(/<xml>(\n|.)*?<\/xml>/ig, "");
            i = i.replace(/\r\n|\n|\r/ig, "");
            i = i.replace(/font-family:[^\;\"\']+;/ig, "");
            i = i.replace(/style=\"\s*\"/ig, "");
            i = i.replace(/<span\s+>/ig, "<span>");
            i = a.util.execGetHtmlHooks(c, i);
            i = a.format.getHtml(i, a.g[c].htmlTags, a.g[c].urlType);
            i = i.replace(/font-size:small;/ig, "");
            i = i.replace(/<p\s+style=\"[^\"]*\"\s*>/ig, "<p class='prg'>");
            i = i.replace(/style=\"font-size:12pt;\"/ig, "class='s5'");
            i = i.replace(/style=\"font-size:14pt;\"/ig, "class='ss4'");
            i = i.replace(/style=\"font-size:15pt;\"/ig, "class='s4'");
            i = i.replace(/style=\"font-size:16pt;\"/ig, "class='ss3'");
            i = i.replace(/style=\"font-size:18pt;\"/ig, "class='s3'");
            i = i.replace(/style=\"\s*\"/ig, "");
            i = i.replace(/<span\s+>/ig, "<span>");
            var h = new RegExp("<s*span|</span>", "ig");
            var j, f = "",
            k = 0,
            d = 0;
            while ((j = h.exec(i)) != null) {
                if (j.index > 0) {
                    f += i.substring(k, j.index)
                }
                if (j[0] == "</span>") {
                    if (d > 0) {--d;
                        k = j.index
    ...
    a.plugin.fullscreen = {
        click: function(k) {
            ...
            var f = function() {
                ...
                h.width = g.clientWidth + "px";
                h.height = g.clientHeight + "px"
            };
            var e = "";
            var c = function() {
                if (!d.isSelected) {
                ...
                var l = a.util.getDocumentElement();
                var g = [l.clientWidth, l.clientHeight].join("");
                if (e != g) {
                    e = g;
                    f();
                    a.util.resize(k, h.width, h.height)
                }
            };
            if (this.isSelected) {
                ...
                a.event.remove(window, "resize", c);
                h.resizeMode = h.config.resizeMode;
                a.toolbar.unselect(k, "fullscreen")
            } else {
                this.isSelected = true;
                this.width = h.container.style.width;
                this.height = h.container.style.height;
                a.util.setData(k);
                a.remove(k, 2);
                document.body.parentNode.style.overflow = "hidden";
                f();
                a.create(k, 1);
                var j = a.util.getScrollPos();
                var i = h.container;
                i.style.position = "absolute";
                i.style.left = j.x + "px";
                i.style.top = j.y + "px";
                i.style.zIndex = 19811211;
                a.event.add(window, "resize", c);
                h.resizeMode = 0;
                a.toolbar.select(k, "fullscreen")
            }
        }
    };
    a.plugin.bgcolor = {
        click: function(d) {
            a.util.selection(d);
            var c = a.queryCommandValue(a.g[d].iframeDoc, "bgcolor");
            this.menu = new a.menu({
                id: d,
                cmd: "bgcolor"
            });
            this.menu.picker(c)
    ...
    a.plugin.fontname = {
        click: function(g) {
            var d = a.lang.plugins.fontname.fontName;
            var e = "fontname";
            a.util.selection(g);
            var f = new a.menu({
                id: g,
            ...
            var c = a.queryCommandValue(a.g[g].iframeDoc, e);
            a.each(d,
            function(i, j) {
                var h = '<span class="ke-reset" style="font-family: ' + i + ';">' + j + "</span>";
                f.add(h,
                function() {
                    a.plugin[e].exec(g, i)
                },
                {
                    checked: (c === i.toLowerCase() || c === j.toLowerCase())
                })
            });
            f.show();
            this.menu = f
    ...
    a.plugin.fontsize = {
        click: function(c) {
            var k = ["9px", "10px", "12px", "14px", "16px", "18px", "24px", "32px"];
            var e = "fontsize";
            a.util.selection(c);
            var l = a.queryCommandValue(a.g[c].iframeDoc, "fontsize");
            var d = new a.menu({
                id: c,
                cmd: e,
                width: 120
            ...
            h = k.length; f < h; f++) {
                var j = k[f];
                var g = '<span class="ke-reset" style="font-size: ' + j + ';">' + j + "</span>";
                d.add(g, (function(i) {
                    return function() {
                        a.plugin[e].exec(c, i)
                    }
                })(j), {
                    height: (parseInt(j) + 12) + "px",
                    checked: (l === j)
                })
            }
            d.show();
    ...
    a.plugin.removeformat = {
        click: function(g) {
            ...
            for (var e = 0,
            c = a.g[g].inlineTags.length; e < c; e++) {
                d[a.g[g].inlineTags[e]] = ["*"]
            }
            f.remove(d);
            a.util.execOnchangeHandler(g);
            a.toolbar.updateState(g);
            a.util.focus(g)
        }
    };
    a.plugin.source = {
        click: function(d) {
            var c = a.g[d];
            if (!c.wyswygMode) {
                a.util.setFullHtml(d, c.newTextarea.value);
                c.iframe.style.display = "block";
                c.newTextarea.style.display = "none";
                a.toolbar.able(d, ["source", "fullscreen"]);
                c.wyswygMode = true;
                this.isSelected = false;
                a.toolbar.unselect(d, "source")
            } else {
                a.hideMenu(d);
                c.newTextarea.value = a.util.getData(d);
                c.iframe.style.display = "none";
                c.newTextarea.style.display = "block";
                a.toolbar.disable(d, ["source", "fullscreen"]);
                c.wyswygMode = false;
                this.isSelected = true;
                a.toolbar.select(d, "source")
            }
            a.util.focus(d)
        }
    };
    a.plugin.textcolor = {
        click: function(d) {
            a.util.selection(d);
            var c = a.queryCommandValue(a.g[d].iframeDoc, "textcolor");
            this.menu = new a.menu({
                id: d,
                cmd: "textcolor"
            });
    ...
    a.plugin.title = {
        click: function(i) {
            ...
            var c = "title";
            a.util.selection(i);
            var f = a.queryCommandValue(a.g[i].iframeDoc, "formatblock");
            var e = new a.menu({
                id: i,
                cmd: c,
                width: (a.langType == "en" ? 200 : 150)
            });
            a.each(g,
            function(k, m) {
                var l = "font-size:" + d[k] + "px;";
                if (k !== "P") {
                    l += "font-weight:bold;"
                }
                var j = '<span class="ke-reset" style="' + l + '">' + m + "</span>";
                e.add(j,
                function() {
                    a.plugin[c].exec(i, "<" + k + ">")
                },
                {
                    height: (d[k] + 12) + "px",
                    checked: (f === k.toLowerCase() || f === m.toLowerCase())
                })
            });
            e.show();
            this.menu = e
        ...
        exec: function(d, c) {
            a.util.select(d);
            a.util.execCommand(d, "formatblock", c);
            this.menu.hide();
            a.util.focus(d)
        }
    };
    a.plugin.emoticons = {
        click: function(r) {
            ...
            w = Math.floor(m / 2),
            u = a.g[r],
            q = u.pluginsPath + "emoticons/",
            o = (u.allowPreviewEmoticons === b) ? true: u.allowPreviewEmoticons;
            a.util.selection(r);
            var f = a.$$("div");
            f.className = "ke-plugin-emoticons-wrapper";
            var s, i;
            if (o) {
                s = a.$$("div");
                s.className = "ke-plugin-emoticons-preview";
                s.style.right = 0;
                var i = a.$$("img");
                i.className = "ke-reset";
                i.src = q + "0.gif";
                i.border = 0;
                s.appendChild(i);
                f.appendChild(s)
            ...
            function j(D) {
                ...
                C.className = "ke-plugin-emoticons-table";
                C.cellPadding = 0;
                C.cellSpacing = 0;
                C.border = 0;
                var z = (D - 1) * h + e;
                for (var A = 0; A < l; A++) {
                    var E = C.insertRow(A);
                    for (var y = 0; y < m; y++) {
                        var g = E.insertCell(y);
                        g.className = "ke-plugin-emoticons-cell";
                        if (s) {
                            g.onmouseover = (function(G, F) {
                                return function() {
                                    if (G > w) {
                                        s.style.left = 0;
                                        s.style.right = ""
                        ...
                        var B = a.$$("span");
                        B.className = "ke-plugin-emoticons-img";
                        B.style.backgroundPosition = "-" + (24 * z) + "px 0px";
                        g.appendChild(B);
                        z++
                    }
                }
            ...
            f.appendChild(v);
            var d = a.$$("div");
            d.className = "ke-plugin-emoticons-page";
            f.appendChild(d);
            function k(y) {
                for (var z = 1; z <= n; z++) {
                    if (y !== z) {
        ...
        exec: function(f, c) {
            var e = a.g[f].pluginsPath + "emoticons/" + c + ".gif";
            var d = '<img src="' + e + '" kesrc="' + e + '" border="0" alt="" />';
            a.util.insertHtml(f, d);
            this.menu.hide();
            a.util.focus(f)
        }
    };
    a.plugin.flash = {
        init: function(d) {
            var c = this;
            a.g[d].getHtmlHooks.push(function(e) {
                return e.replace(/<img[^>]*class="?ke-flash"?[^>]*>/ig,
                function(i) {
                    var h = i.match(/style="[^"]*;?\s*width:\s*(\d+)/i) ? RegExp.$1: 0;
                    var f = i.match(/style="[^"]*;?\s*height:\s*(\d+)/i) ? RegExp.$1: 0;
                    h = h || (i.match(/width="([^"]+)"/i) ? RegExp.$1: 0);
                    f = f || (i.match(/height="([^"]+)"/i) ? RegExp.$1: 0);
                    if (i.match(/kesrctag="([^"]+)"/i)) {
                        var g = a.util.getAttrList(unescape(RegExp.$1));
                        g.width = h || g.width || 0;
                        g.height = f || g.height || 0;
                        g.kesrc = g.src;
                        return a.util.getMediaEmbed(g)
                    }
                })
            });
            a.g[d].setHtmlHooks.push(function(e) {
                return e.replace(/<embed[^>]*type="application\/x-shockwave-flash"[^>]*>(?:<\/embed>)?/ig,
                function(g) {
                    var j = g.match(/\s+src="([^"]+)"/i) ? RegExp.$1: "";
                    if (g.match(/\s+kesrc="([^"]+)"/i)) {
                        j = RegExp.$1
                    }
                    var i = g.match(/\s+width="([^"]+)"/i) ? RegExp.$1: 0;
                    var f = g.match(/\s+height="([^"]+)"/i) ? RegExp.$1: 0;
                    var h = a.util.getAttrList(g);
                    h.src = j;
                    h.width = i;
                    h.height = f;
                    return a.util.getMediaImage(d, "flash", h)
                })
            })
        },
        click: function(c) {
        ...
        check: function(g, e, f, c) {
            var d = a.util.getIframeDoc(this.dialog.iframe);
            if (!e.match(/^.{3,}$/)) {
        ...
        exec: function(h) {
            ...
            var d = a.$("url", e).value;
            var g = a.$("width", e).value;
            var c = a.$("height", e).value;
            if (!this.check(h, d, g, c)) {
                return false
            }
            var f = a.util.getMediaImage(h, "flash", {
                src: d,
                type: a.g[h].mediaTypes.flash,
                width: g,
                height: c,
                quality: "high"
            });
    ...
    a.plugin.image = {
        getSelectedNode: function(f) {
            var e = a.g[f];
            var d = e.keRange.startNode;
            var c = e.keRange.endNode;
            if (!a.browser.WEBKIT && !e.keSel.isControl) {
                return
            }
            if (d.nodeType != 1) {
                return
        ...
        init: function(e) {
            ...
            d.contextmenuItems.push({
                text: a.lang.deleteImage,
                click: function(h, g) {
                    a.util.select(h);
                    g.hide();
                    var f = c.getSelectedNode(h);
                    f.parentNode.removeChild(f);
                    a.util.execOnchangeHandler(h)
                },
                cond: function(f) {
                    return c.getSelectedNode(f)
                },
        ...
        check: function(i) {
            var d = a.util.getIframeDoc(this.dialog.iframe);
            var g = a.$("type", d).value;
            var f = a.$("imgWidth", d).value;
            var c = a.$("imgHeight", d).value;
            var h = a.$("imgTitle", d).value;
            var e;
            if (g == 2) {
                e = a.$("imgFile", d)
            } else {
            ...
            if (!e.value.match(/\.(jpg|jpeg|gif|bmp|png)(\s|\?|$)/i)) {
        ...
        exec: function(e) {
            var q = this;
            var h = a.util.getIframeDoc(this.dialog.iframe);
            var l = a.$("type", h).value;
            var f = a.$("imgWidth", h).value;
            var p = a.$("imgHeight", h).value;
            var n = a.$("imgTitle", h).value;
            var o = h.getElementsByName("align");
            var k = "";
            for (var g = 0,
            j = o.length; g < j; g++) {
                if (o[g].checked) {
            ...
            if (l == 2) {
                a.$("editorId", h).value = e;
                var d = a.$("uploadIframe", h);
                a.util.showLoadingPage(e);
                var m = function() {
                    a.event.remove(d, "load", m);
                    a.util.hideLoadingPage(e);
                    var s = a.util.getIframeDoc(d);
                    var i = "";
                    try {
                        i = a.util.parseJson(s.body.innerHTML)
                    } catch(r) {
                        alert(a.lang.invalidJson)
                    }
                    if (typeof i === "object" && "error" in i) {
                        if (i.error === 0) {
                            q.insert(e, i.url, n, f, p, 0, k)
                        } else {
                            alert(i.message);
                            return false
                        }
                ...
                a.event.add(d, "load", m);
                h.uploadForm.submit();
                return
            } else {
                var c = a.$("url", h).value;
                this.insert(e, c, n, f, p, 0, k)
            }
        },
        insert: function(j, e, h, g, c, d, i) {
            var f = '<img src="' + e + '" kesrc="' + e + '" ';
            if (g > 0) {
                f += 'width="' + g + '" '
            }
            if (c > 0) {
            ...
            f += 'alt="' + h + '" ';
            f += 'border="' + d + '" />';
            a.util.insertHtml(j, f);
            this.dialog.hide();
            a.util.focus(j)
        }
    };
    a.plugin.link = {
        getSelectedNode: function(c) {
            return a.getCommonAncestor(a.g[c].keSel, "a")
        },
        init: function(d) {
            var c = this;
            a.g[d].contextmenuItems.push({
        ...
        exec: function(n) {
            ...
            var m = j.endNode;
            var h = s.iframeDoc;
            var o = a.util.getIframeDoc(this.dialog.iframe);
            var d = a.$("hyperLink", o).value;
            var w = a.$("linkType", o).value;
            if (!d.match(/.+/) || d.match(/^\w+:\/\/\/?$/)) {
                alert(a.lang.invalidUrl);
                a.$("hyperLink", o).focus();
                return false
            }
            var p = j.getParentElement();
            while (p) {
                if (p.tagName.toLowerCase() == "a" || p.tagName.toLowerCase() == "body") {
                    break
                }
                p = p.parentNode
            }
            ...
            if (a.browser.IE) {
                ...
                t = (v.nodeType == 1 && v === m && v.nodeName.toLowerCase() != "br")
            }
            var k = !t;
            if (!t) {
                k = a.browser.IE ? s.range.text === "": s.range.toString() === ""
            }
            if (k || a.util.isEmpty(n)) {
                var f = '<a href="' + d + '"';
                if (w) {
                    f += ' target="' + w + '"'
                }
                f += ">" + d + "</a>";
                a.util.insertHtml(n, f)
            } else {
                h.execCommand("createlink", false, "__ke_temp_url__");
                var c = p.getElementsByTagName("a");
                for (var r = 0,
                q = c.length; r < q; r++) {
                    if (c[r].href.match(/\/?__ke_temp_url__$/)) {
                        c[r].href = d;
                        c[r].setAttribute("kesrc", d);
                        if (w) {
                            c[r].target = w
                        } else {
                            c[r].removeAttribute("target")
                        }
                    }
                }
                if (a.browser.WEBKIT && t && v.tagName.toLowerCase() == "img") {
                    var e = v.parentNode;
    ...
    a.plugin.unlink = {
        init: function(d) {
            ...
            a.g[d].contextmenuItems.push({
                ...
                cond: function(e) {
                    return a.plugin.link.getSelectedNode(e)
                },
                options: {
                    width: "150px",
        ...
        click: function(c) {
            ...
            var d = f.startNode;
            var j = f.endNode;
            var h = (d.nodeType == 1 && d === j);
            var e = !h;
            if (!h) {
                e = a.browser.IE ? i.range.text === "": i.range.toString() === ""
            }
            if (e) {
                var k = a.plugin.link.getSelectedNode(c);
                if (!k) {
                    return
                }
                var f = i.keRange;
                ...
                i.keSel.addRange(f);
                a.util.select(c);
                l.execCommand("unlink", false, null);
                if (a.browser.WEBKIT && d.tagName.toLowerCase() == "img") {
                    var m = d.parentNode;
                    if (m.tagName.toLowerCase() == "a") {
                        a.util.removeParent(m);
                        i.keSel.addRange(f)
                    }
                }
            } else {
    ...
    a.plugin.media = {
        init: function(e) {
            var c = this;
            var d = {};
            a.each(a.g[e].mediaTypes,
            function(f, g) {
                d[g] = f
            });
            a.g[e].getHtmlHooks.push(function(f) {
                return f.replace(/<img[^>]*class="?ke-\w+"?[^>]*>/ig,
                function(h) {
                    var j = h.match(/style="[^"]*;?\s*width:\s*(\d+)/i) ? RegExp.$1: 0;
                    var g = h.match(/style="[^"]*;?\s*height:\s*(\d+)/i) ? RegExp.$1: 0;
                    j = j || (h.match(/width="([^"]+)"/i) ? RegExp.$1: 0);
                    g = g || (h.match(/height="([^"]+)"/i) ? RegExp.$1: 0);
                    if (h.match(/\s+kesrctag="([^"]+)"/i)) {
                        var i = a.util.getAttrList(unescape(RegExp.$1));
                        i.width = j || i.width || 0;
                        i.height = g || i.height || 0;
                        i.kesrc = i.src;
                        return a.util.getMediaEmbed(i)
                    }
                })
            });
            a.g[e].setHtmlHooks.push(function(f) {
                return f.replace(/<embed[^>]*type="([^"]+)"[^>]*>(?:<\/embed>)?/ig,
                function(i, h) {
                    ...
                    var g = i.match(/\s+height="([^"]+)"/i) ? RegExp.$1: 0;
                    var j = a.util.getAttrList(i);
                    j.src = l;
                    j.width = k;
                    j.height = g;
                    return a.util.getMediaImage(e, "", j)
                })
            })
        },
        click: function(c) {
        ...
        check: function(g, e, f, c) {
            var d = a.util.getIframeDoc(this.dialog.iframe);
            if (!e.match(/^.{3,}\.(swf|flv|mp3|wav|wma|wmv|mid|avi|mpg|mpeg|asf|rm|rmvb)(\?|$)/i)) {
        ...
        exec: function(i) {
            ...
            var g = a.$("width", e).value;
            var c = a.$("height", e).value;
            if (!this.check(i, d, g, c)) {
                return false
            }
            var h = a.$("autostart", e).checked ? "true": "false";
            var f = a.util.getMediaImage(i, "", {
                src: d,
                type: a.g[i].mediaTypes[a.util.getMediaType(d)],
                width: g,
                height: c,
                autostart: h,
                loop: "true"
            });
            a.util.insertHtml(i, f);
            this.dialog.hide();
            a.util.focus(i)
        }
    };
    a.plugin.accessory = {
        ...
        check: function(h) {
            var f = a.util.getIframeDoc(a.g[h].dialog);
            var g = a.$("type", f).value;
            var e = "";
            if (g == 1) {
                e = a.$("imgFile", f).value
            } else {
            ...
            var c = (typeof a.g[h].accessoryTypes == "undefined") ? "doc|xls|pdf|txt|ppt|rar|zip": a.g[h].accessoryTypes;
            var d = "^.*?.(" + c + ")$";
            if (e.match(d) == null) {
                alert("请输入有效的URL地址。\n只允许" + c + "格式。");
                window.focus();
                a.g[h].yesButton.focus();
                return false
            }
            return true
        },
        exec: function(g) {
            a.util.select(g);
            var d = a.util.getIframeDoc(a.g[g].dialog);
            var e = a.$("type", d).value;
            if (!this.check(g)) {
                return false
            }
            if (e == 1) {
                a.$("editorId", d).value = g;
                d.uploadForm.submit();
                return false
            } else {
                var c = a.$("url", d).value;
                var f = a.$("attachTitle", d).value;
                this.insert(g, c, f, ext)
            }
        },
        insert: function(j, d, i, f) {
            var c;
            var g = a.g[j].pluginsPath + "accessory/";
            var h = "attach.png";
            switch (f) {
            case "doc":
                c = g + "ico/doc.png";
            ...
            var e = '<img src="' + c + '" title="' + h + '">&nbsp;';
            e += '<a href="' + d + '" title="' + i + '">';
            if (i) {
                e += i
            }
            e += "</a>";
            a.util.insertHtml(j, e);
            a.layout.hide(j);
            a.util.focus(j)
        }
    };
    a.plugin.advtable = {
        getSelectedTable: function(c) {
            return a.getCommonAncestor(a.g[c].keSel, "table")
        },
        getSelectedRow: function(c) {
            return a.getCommonAncestor(a.g[c].keSel, "tr")
        },
        getSelectedCell: function(c) {
            return a.getCommonAncestor(a.g[c].keSel, "td")
        },
        tableprop: function(c) {
            this.click(c)
        },
        tableinsert: function(c) {
            this.click(c, "insert")
        },
        tabledelete: function(d) {
            var c = this.getSelectedTable(d);
            c.parentNode.removeChild(c)
        },
        tablecolinsert: function(k, j) {
            var g = this.getSelectedTable(k),
            d = this.getSelectedCell(k),
            e = d.cellIndex + j;
            for (var f = 0,
            c = g.rows.length; f < c; f++) {
                var h = g.rows[f].insertCell(e);
                h.innerHTML = "&nbsp;"
            }
        },
        tablecolinsertleft: function(c) {
            this.tablecolinsert(c, 0)
        },
        tablecolinsertright: function(c) {
            this.tablecolinsert(c, 1)
        },
        tablerowinsert: function(k, j) {
            var g = this.getSelectedTable(k),
            h = this.getSelectedRow(k),
            e = g.insertRow(h.rowIndex + j);
            for (var f = 0,
            d = h.cells.length; f < d; f++) {
                var c = e.insertCell(f);
                c.innerHTML = "&nbsp;"
            }
        },
        tablerowinsertabove: function(c) {
            this.tablerowinsert(c, 0)
        },
        tablerowinsertbelow: function(c) {
            this.tablerowinsert(c, 1)
        },
        tablecoldelete: function(g) {
            var f = this.getSelectedTable(g);
            var d = this.getSelectedCell(g);
            for (var e = 0,
            c = f.rows.length; e < c; e++) {
                f.rows[e].deleteCell(d.cellIndex)
            }
        },
        tablerowdelete: function(e) {
            var c = this.getSelectedTable(e);
            var d = this.getSelectedRow(e);
            c.deleteRow(d.rowIndex)
        },
        init: function(j) {
            var d = this;
            var g = "ke-zeroborder";
            var h = "prop,colinsertleft,colinsertright,rowinsertabove,rowinsertbelow,coldelete,rowdelete,insert,delete".split(",");
            for (var f = 0,
            c = h.length; f < c; f++) {
                var e = "table" + h[f];
                a.g[j].contextmenuItems.push({
                    text: a.lang[e],
                    click: (function(i) {
                        return function(l, k) {
                            a.util.select(l);
                    ...
                    cond: (function(i) {
                        if (a.util.inArray(i, ["tableprop", "tabledelete"])) {
                            return function(k) {
                                return d.getSelectedTable(k)
                            }
                        } else {
                            return function(k) {
                                return d.getSelectedCell(k)
                            }
                        }
                    })(e),
                    options: {
                        width: "170px",
                        iconHtml: '<span class="ke-common-icon ke-common-icon-url ke-icon-' + e + '"></span>'
                    }
                })
            }
            a.g[j].contextmenuItems.push("-");
            a.g[j].setHtmlHooks.push(function(i) {
                return i.replace(/<table([^>]*)>/ig,
                function(l, k) {
                    if (k.match(/\s+border=["']?(\d*)["']?/ig)) {
                        var m = RegExp.$1;
                        if (k.indexOf(g) < 0 && (m === "" || m === "0")) {
                            return a.addClass(l, g)
                        } else {
                            return l
                        }
                    } else {
        ...
        click: function(e, d) {
            ...
            this.dialog = new a.dialog({
                id: e,
                cmd: c,
                file: "advtable/advtable.html?mode=" + d,
                width: 420,
                height: 220,
                loadingMode: true,
        ...
        exec: function(y) {
            var r = "ke-zeroborder";
            var z = a.util.getIframeDoc(this.dialog.iframe);
            var v = a.$("mode", z);
            var e = a.$("rows", z);
            var m = a.$("cols", z);
            var h = a.$("width", z);
            var K = a.$("height", z);
            var u = a.$("widthType", z);
            var s = a.$("heightType", z);
            var E = a.$("padding", z);
            var G = a.$("spacing", z);
            var c = a.$("align", z);
            var o = a.$("border", z);
            var x = a.$("borderColor", z);
            var J = a.$("backgroundColor", z);
            var n = e.value;
            var q = m.value;
            var A = h.value;
            var w = K.value;
            ...
            if (v.value === "update") {
                ...
                if (B !== "") {
                    I.setAttribute("border", B)
                } else {
                    I.removeAttribute("border")
                }
                if (d !== "") {
                    I.setAttribute("borderColor", d)
                } else {
                    I.removeAttribute("borderColor")
                }
                a.util.execOnchangeHandler(y)
            } else {
                var H = "";
                if (A !== "") {
                    H += "width:" + A + f + ";"
                ...
                p += "</table>";
                a.util.insertHtml(y, p)
            }
            this.dialog.hide();
            a.util.focus(y)
        }
    };
    a.plugin.specialchar = {
        click: function(c) {
            var h = [["§", "№", "☆", "★", "○", "●", "◎", "◇", "◆", "□"], ["℃", "‰", "■", "△", "▲", "※", "→", "←", "↑", "↓"], ["〓", "¤", "°", "＃", "＆", "＠", "＼", "︿", "＿", "￣"], ["―", "α", "β", "γ", "δ", "ε", "ζ", "η", "θ", "ι"], ["κ", "λ", "μ", "ν", "ξ", "ο", "π", "ρ", "σ", "τ"], ["υ", "φ", "χ", "ψ", "ω", "≈", "≡", "≠", "＝", "≤"], ["≥", "＜", "＞", "≮", "≯", "∷", "±", "＋", "－", "×"], ["÷", "／", "∫", "∮", "∝", "∞", "∧", "∨", "∑", "∏"], ["∪", "∩", "∈", "∵", "∴", "⊥", "∥", "∠", "⌒", "⊙"], ["≌", "∽", "〖", "〗", "【", "】", "（", "）", "［", "］"]];
            var e = "specialchar";
            a.util.selection(c);
            var l = a.$$("table");
            l.cellPadding = 0;
            ...
            l.style.borderSpacing = "2px";
            for (var g = 0; g < h.length; g++) {
                var m = l.insertRow(g);
                for (var f = 0; f < h[g].length; f++) {
                    var k = m.insertCell(f);
                    k.style.padding = "1px";
                    k.style.margin = 0;
                    k.style.border = "1px solid #AAAAAA";
                    ...
                    k.onclick = new Function('KE.plugin["' + e + '"].exec("' + c + '", "' + h[g][f] + '")');
                    k.innerHTML = h[g][f]
                }
            }
            var d = new a.menu({
    ...
    a.plugin.date = {
        click: function(h) {
            ...
            var g = (d.getMonth() + 1).toString();
            g = g.length < 2 ? "0" + g: g;
            var c = d.getDate().toString();
            c = c.length < 2 ? "0" + c: c;
            var f = e + "-" + g + "-" + c;
            a.util.selection(h);
            a.util.insertHtml(h, f);
    ...
    a.plugin.time = {
        click: function(h) {
            ...
            c = c.length < 2 ? "0" + c: c;
            var g = e.getMinutes().toString();
            g = g.length < 2 ? "0" + g: g;
            var d = e.getSeconds().toString();
            d = d.length < 2 ? "0" + d: d;
            var f = c + ":" + g + ":" + d;
            a.util.selection(h);
            a.util.insertHtml(h, f);
    ...
    a.plugin.preview = {
        click: function(d) {
            var c = new a.dialog({
                id: d,
                cmd: "preview",
                html: a.util.getData(d),
                width: 600,
                height: 400,
                useFrameCSS: true,
                title: a.lang.preview,
                noButton: a.lang.close
            });
            c.show()
        }
